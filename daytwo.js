...
let strings = '30 Days Of'
console.log(strings.concat("JavaScript"))
...
console.log(b.search('on'))

//I hope this course is not full of jargon. Check if jargon is in the sentence.
let jrgn = 'I hope this course is not full of jargon'
console.log(jrgn.search('jargon'))

//Generate a random number between 0 and 100 inclusively.
let randnum = Math.random()
let num2 = randnum * 101
let ranfloor = Math.floor(num2)
...
let charac = strng.split('')
let rand = Math.floor(Math.random() * 10)
console.log(charac[rand])
...
//Clean the following text and find the most frequent word (hint, use replace and regular expressions).
    ...
    let clean = sentences.replace(/[^a-zA-Z ]/g, "")
    let k = clean.split(' ')
    console.log(clean)
    for (let c =0; c <= k.length; c++ )
{
    ...
    console.log(clean.match(re))
    
    //console.log(clean.match(y.length))
}
